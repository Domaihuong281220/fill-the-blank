...
const DragAndDrop = () => {
    ...
    const resetBlanks = () => {
        // Use a local flag to ensure words are added back only once per function call
        let wordsAddedBack = false;

        setBlanks(prevBlanks => {
            // Extract words currently in blanks
            ...
            if (!wordsAddedBack && wordsToReturn.length > 0) {
                // Only add words back if they haven't been added yet in this function call
                wordsAddedBack = true;

                // Add these words back to dragWords
                setDragWords(prevWords => {
                    // Find the original data for each word to return correct properties
    ...
    return (
        <div className="container">
            ...
            <div className="submit-container">
                ...
                <button class="gitBtn">
                    <a href="https://github.com/Domaihuong281220/fill-the-blank">
